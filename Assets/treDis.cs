      ...
      //  [ReadOnly] public NativeArray<Color32> VCA;
        ...
        void IJobParallelFor.Execute(int id)
        {
            ...
            /////////
                ...
                float sptexsel = 1.0f / spw;
                float sptexselH = sptexsel * 0.5f;
            ///サンプル点座標
            ...
            ////////////////////
                ...
                int sptx1 = (int)((uvO.x + sptexselH) * spw);
                int spty1 = (int)((uvO.y + sptexselH) * sph);
                int sptx2 = (int)((uvO.x + sptexselH) * spw);
                int spty2 = (int)((uvO.y - sptexselH) * sph);
                int sptx3 = (int)((uvO.x - sptexselH) * spw);
                int spty3 = (int)((uvO.y + sptexselH) * sph);
                int sptx4 = (int)((uvO.x - sptexselH) * spw);
                int spty4 = (int)((uvO.y - sptexselH) * sph);
            ////////////////////
                float fx = ((uvsA[id].x-texselH) * w) % 1f;
                float fy = ((uvsA[id].y-texselH) * h) % 1f;
                float cfx = ((uvO.x - sptexselH) * spw) % 1f;
                float cfy = ((uvO.y - sptexselH) * sph) % 1f;
            ...
            cf3 = cc[d3];
            cf4 = cc[d4];
            Color dx = (cf4 * (1 - fx)) + (cf2 * fx);
            Color dx2 = (cf3 * (1 - fx)) + (cf1 * fx);
            Color dispr = (dx * (1 - fy)) + (dx2 * fy);
            ///////////////////////////////////////////////
            ///スプラトマップバイリニア
            d0 = spx + spy * spw;
            d1 = sptx1 + spty1 * spw;
            ...
            d4 = sptx4 + spty4 * spw;
            /////飛び出したら補正
            if (d0 > spcc.Length - 1) d0 = spcc.Length - 1;
            if (d0 < 0) d0 = 0;
            if (d1 > spcc.Length - 1) d1 = d0;
            if (d1 < 0) d1 = d0;
            if (d2 > spcc.Length - 1) d2 = d0;
            if (d2 < 0) d2 = d0;
            if (d3 > spcc.Length - 1) d3 = d0;
            if (d3 < 0) d3 = d0;
            if (d4 > spcc.Length - 1) d4 = d0;
            if (d4 < 0) d4 = d0;
            ...
            cf3 = spcc[d3];
            cf4 = spcc[d4];
            Color cx = (cf4 * (1 - cfx)) + (cf2 * cfx);
            Color cx2 = (cf3 * (1 - cfx)) + (cf1 * cfx);
            Color cxB = (cx * (1 - cfy)) + (cx2 * cfy);
            Color32 cxBo = cxB;
            /////////////////////////////
            disp = dispr.r*10f;
